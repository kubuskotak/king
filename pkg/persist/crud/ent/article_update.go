...
func (au *ArticleUpdate) AddUserID(i int) *ArticleUpdate {
...
func (au *ArticleUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if au.mutation.UserIDCleared() {
		_spec.ClearField(article.FieldUserID, field.TypeInt)
	}
...
// AddUserID adds i to the "user_id" field.
func (auo *ArticleUpdateOne) AddUserID(i int) *ArticleUpdateOne {
